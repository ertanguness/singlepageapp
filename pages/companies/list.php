...
<div class="filter-section">
	<ul>
		<li>
			<div class="view-icons">
				<a href="deals.html" class="list-view btn btn-link active"><i class="las la-list"></i></a>
				<a href="deals-kanban.html" class="grid-view btn btn-link"><i class="las la-th"></i></a>
			</div>
		</li>
		<li>
			<div class="form-sort">
						...
						<td class="text-end">
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a class="dropdown-item" href="deals-details.html"><i class="fa-regular fa-eye"></i> Preview</a>
								</div>
							</div>
						</td>
					</tr>
